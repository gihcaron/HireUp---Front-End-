      ...
      {/* Oportunidade de Trabalho */}
        ...
        <div className={styles.categoriesContent}>
          ...
          <div className={styles.categoryCard}>
            ...
            <div className={styles.categoryCount}>+{dataJobs.jobs.filter(j => /Desenvolvedor|Engineer|Engenheiro|Arquiteto|DevOps|QA|Tester|Dados|Machine/i.test(j.title)).length} vagas</div>
          </div>
          <div className={styles.categoryCard}>
            <FaBullhorn className={styles.categoryIcon} />
            <h3>Marketing</h3>
            <p>Profissionais de marketing digital e criação</p>
            <div className={styles.categoryCount}>+{dataJobs.jobs.filter(j => /Marketing|Social|Mídia|Conteúdo|Designer/i.test(j.title)).length} vagas</div>
          </div>
          <div className={styles.categoryCard}>
            <FaUsers className={styles.categoryIcon} />
            <h3>Recursos Humanos</h3>
            <p>Recrutadores e especialistas em RH</p>
            <div className={styles.categoryCount}>+{dataJobs.jobs.filter(j => /RH|Humanos|Recrutador| Projetos|People|Business Partner/i.test(j.title)).length}  vagas</div>
          </div>
          <div className={styles.categoryCard}>
            <FaCogs className={styles.categoryIcon} />
            <h3>Operações</h3>
            <p>Coordenadores e gerentes de processos</p>
            <div className={styles.categoryCount}>+{dataJobs.jobs.filter(j => /Gerente|Coordenador|Product|Scrum|Consultor/i.test(j.title)).length} vagas</div>
          </div>
          </div>
        </div>
        </section>
